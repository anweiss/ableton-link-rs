...
async fn test_node_id_preservation_across_enable_disable() {
    ...
    assert_eq!(
        initial_node_id, enabled_node_id,
        "NodeId should be preserved after enable"
    );
    ...
    assert_eq!(
        initial_node_id, disabled_node_id,
        "NodeId should be preserved after disable"
    );
    ...
    assert_eq!(
        initial_node_id, re_enabled_node_id,
        "NodeId should be preserved after re-enable"
    );
