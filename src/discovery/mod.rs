...
pub const UNICAST_IP_ANY: SocketAddrV4 = SocketAddrV4::new(Ipv4Addr::new(192, 168, 1, 23), 0);
pub const MULTICAST_IP_ANY: SocketAddrV4 = SocketAddrV4::new(Ipv4Addr::new(0, 0, 0, 0), 20808);
