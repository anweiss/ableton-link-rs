...
| `link-upstream-port.md` | Weekly, Thursday | Takes the earliest outstanding backlog item that is not `blocked_on` a design decision, ports it, runs the full CI suite, and opens a draft PR |
